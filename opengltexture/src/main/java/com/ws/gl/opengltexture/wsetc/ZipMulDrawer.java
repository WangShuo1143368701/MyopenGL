...
import com.ws.gl.opengltexture.wsfifter.AFilter;
import com.ws.gl.opengltexture.wsutils.Gl2Utils;
...
public class ZipMulDrawer extends AFilter {
    ...
    protected void onBindTexture() {
        ...
        Log.e("wangshuo","is ETC null->"+(t==null));
    ...
    public void draw() {
        if(time!=0){
            Log.e("wangshuo","time-->"+(System.currentTimeMillis()-time));
        }
